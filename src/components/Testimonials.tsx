        ...
        >
          {clientSayData.map((item, index) => (
            <SwiperSlide key={index}>
              <div className="py-3 px-4 rounded-lg border-appPurple/40 bg-[#d8cbf350] backdrop-blur-5xl shadow-xl text-[#07000E] border">
                <div className="flex lg:items-center gap-3">
                  ...
                  <div className="lg:mb-0 mb-2">
                    <h3 className="font-bold text-lg text-[#31156ee4]">
                      {item.name}
                    </h3>
