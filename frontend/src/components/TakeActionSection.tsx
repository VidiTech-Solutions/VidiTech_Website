  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.p
          className="w-full text-base md:text-lg my-6 text-[#D4CDE3] max-w-[53rem]"
          variants={itemVariants}
        >
        ...
        <motion.button
          className="mt-6 bg-appWhite hover:opacity-90 transition-all duration-300 text-appPurple py-3.5 px-4 rounded-md"
          variants={itemVariants}
        >
          <Link
